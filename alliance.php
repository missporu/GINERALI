...
?><small>Ещё один восстановится через:<span style="float: right;"><?= _Time($time) ?></span></small><?
    ...
    case 'udalil':
        ...
        ?><div class="block_zero center">Игрок, приведенный Вами в игру, при регистрации получает <img src="/images/icons/gold.png" alt="Золото"/>20 премиальных. А Вы, в свою очередь, получаете 10% от заработанных им баксов и 50% от покупаемого им золота.</div><div class="mini-line"></div><div class="block_zero center">Как пригласить реферала?</div><div class="dot-line"></div><div class="block_zero center">Передать ему ссылку:<br/>http://war-game.tk/reg.php?ref=<?=$user_id?><br/>либо опубликовать данную сылку в соцсетях: Twitter , Вконтакте, Facebook, Одноклассники и т.д.</div><div class="mini-line"></div><div class="block_zero center">Ваших рефералов: <?=$all_ref?></div><div class="mini-line"></div><?
