...
$data=_FetchAssoc('SELECT * FROM `user_bonus` WHERE `id_user`="'.$user_id.'" LIMIT 1');

if($data['status_bonus']==1){
...
$bonus_baks=$set['lvl']*100*$bonus['status_day'];
...
?>Заходи каждый день и получай <img src="/images/icons/gold.png" alt="Золото"/>1 и <img src="/images/icons/baks.png" alt="Бакс"/><br/>А если заходить в игру 5 дней подряд, то получишь от <img src="/images/icons/gold.png" alt="Золото"/>10 до <img src="/images/icons/gold.png" alt="Золото"/>100 и <img src="/images/icons/baks.png" alt="Бакс"/></div><div class="mini-line"></div><div class="block_zero center"><a class="btn" href="bonus.php"><span class="end"><span class="label"><span class="dgreen">Забрать и продолжить</span></span></span></a></div></div><?
