...
$start_text=_FetchAssoc("SELECT `text` FROM `start` WHERE `case`='".$_GET['case']."' LIMIT 1");
...
mysql_query("UPDATE `user_set` SET `start`='1' WHERE `id`='".$user_id."'");
...
$start_bonus=_NumFilter($data_bonus['start_bonus']);
if($set_strana=='b'){
$hp_bonus=120;
}else{
$hp_bonus=100;
